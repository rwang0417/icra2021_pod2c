...
void init(void)
{
    ...
    matReadOpt("arma_fdbk.mat", "MCK", &MCK);
    matReadOpt("arma_fdbk.mat", "MQ", &MQ);
    matReadOpt("arma_fdbk.mat", "MQU", &MQU);
    matReadOpt("arma_fdbk.mat", "MTK", &MTK, &MTKM);
    matReadOpt("arma_fdbk.mat", "MYE", &MYE, &MYEM);
    matReadOpt("arma_fdbk.mat", "MYM", &MYM, &MYMM);
    matReadOpt("arma_fdbk.mat", "MU1", &MU1, &MU1M);
